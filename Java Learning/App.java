...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String content = getContentsOfFile(path);
    System.out.print("\n");
    System.out.println("What words would you like to search for?");
    String[] tics = getTicsFromUser();
    System.out.println("\n...............................Analyzing text.................................\n");
    System.out.println("Total number of tics: " + sumOfAllTics(tics, content));
    System.out.println("Density of tics: " + calculateTicDensity(tics, content));
    System.out.println("\n...............................Tic breakdown..................................\n"); 

    for (int i=0; i<tics.length; i++){
      String column1 = String.format("%-10s", tics[i]);
      String column2 = String.format("%-20s", " " + countOccurrences(tics[i], content) + " occurrences");
      System.out.println(column1 + "/" + column2 + "/" + " " + calculatePercentage(countOccurrences(tics[i], content), sumOfAllTics(tics, content)) + "% of all tics");
    }
 ...
 /**
  ...
  public static String[] getTicsFromUser() {
    ...
    // String[] inputAsArray = tics.split("[ ,]+");
    String[] inputAsArray = tics.split("[,]+");
 ...
 /**
  ...
  public static int countOccurrences(String needle, String haystack) {
    ...
    String[] seperatedWords = haystack.split("[ \n\t.,?!]+");
    int totalNumber = seperatedWords.length;
    int counter =0;
    
    for (int i=0; i<totalNumber; i++) {
      if (needle.equals(seperatedWords[i])){
        counter++;
      }
    }
    return counter;
  ...
  public static int calculatePercentage(int num1, int num2) {
    float numerator = num1;
    float denominator = num2;
    float shareOfNum1InNum2 = numerator/denominator;
    int percentage = Math.round(shareOfNum1InNum2*100);
  ...
  public static double calculateTicDensity(String[] tics, String fullText) {
    ...
    for (int i=0; i<tics.length; i++){
      sumOfAllTics += countOccurrences(tics[i], fullText);
    }
    String[] seperatedWords = fullText.split("[ \n\t.,?!]+");
    int totalNumber = seperatedWords.length;
    double numerator = sumOfAllTics;
    double denominator = totalNumber;
    double ratio = numerator/denominator;
    String formatRatio = String.format("%.2f", ratio);
    double ratioOutput = Double.parseDouble(formatRatio);
    return ratioOutput;
  }

  public static int sumOfAllTics(String[] tics, String fullText){
    int sumOfAllTics = 0;
